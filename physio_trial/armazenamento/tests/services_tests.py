...
sessoes_atualizadas: list[dict[str, int | datetime]] = [
    {'id_sessao': 1, 'dia_horario': datetime(2025, 12, 22, 9, 1).isoformat(), 'status_agendamento': True, 'conclusao': False},
    {'id_sessao': 2, 'dia_horario': datetime(2025, 12, 29, 9, 29).isoformat(), 'status_agendamento': True, 'conclusao': False}
]
