...
class AgendaPessoa(BaseFrame):
    ...
    def __init__(self, master, voltar_callback, pessoa):
        ...
        self.btn_voltar.grid(row=6, column=1, sticky="e", padx=(20,20), pady=(10,20))
    ...
    def exibir_sessoes(self):
        ...
        for i, s in enumerate(sessoes):
            ...
            self.label_sessao = self.widgets.label(self, texto=texto, cor="transparent")
            self.label_sessao.grid(row=i+1, column=1, sticky="e", padx=(20,20), pady=(20,10))