...
class MenuPesquisador(BaseFrame):
    ...
    def __init__(self, master, voltar_callback, cadastro_paciente, abrir_agenda, abrir_restricoes):
        ...
        self.btn_listar_paci = self.widgets.button(self.container, texto="Listar Pacientes", comando=None, cor="blue")
        self.btn_listar_paci.grid(row=1, column=1, padx=10, pady=10)

        self.btn_agenda = self.widgets.button(self.container, texto="Agenda", comando=self.abrir_agenda, cor="blue")
        self.btn_agenda.grid(row=1, column=2, padx=10, pady=10)
        ...
        self.btn_restricoes.grid(row=1, column=3, sticky="w", padx=10, pady=10)
