...
class MenuAdministrador(BaseFrame):
    ...
    def __init__(self, master, voltar_callback):
        ...
        self.btn_fisioterapeuta = self.widgets.button(self.container, texto="Cadastrar Fisioterapeuta", comando=self.cadastro_fisioterapeuta, cor="blue")
        self.btn_fisioterapeuta.grid(row=1, column=0, sticky="w", padx=10, pady=10)

        self.btn_pesquisador = self.btn_cadastrar_paci = self.widgets.button(self.container, texto="Cadastrar Pesquisador", comando=self.cadastro_pesquisador, cor="blue")
        self.btn_pesquisador.grid(row=1, column=1, sticky="w", padx=10, pady=10)

        self.btn_listar_fisioterapeuta = self.widgets.button(self.container, texto="Listar Fisioterapeutas", comando=self.listar_fisioterapeutas, cor="blue")
