...
class CadastroFisioterapeuta(BaseFrame):
    ...
    def enviar(self):
        id_fisioterapeuta = self.entry_id.get()
        nome = self.entry_nome.get()
        self.storage.adiciona_fisioterapeuta(id_fisioterapeuta, nome)
        print("Fisioterapeuta salvo com sucesso!")
        self.storage.retorna_fisioterapeuta()