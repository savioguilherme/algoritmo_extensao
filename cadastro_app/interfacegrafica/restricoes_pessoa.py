...
class RestricoesPessoa(BaseFrame):
    ...
    def __init__(self, master, voltar_callback):
        ...
        self.label_dia = self.widgets.label(self.container, "Escolha o dia da semana: ", cor="transparent")
        self.label_dia.grid(row=1, column=0, sticky="w", padx=10, pady=10)
        
        self.optionmenu_dia = self.widgets.option_menu(self.container, ["Segunda - Feira", "Terça - Feira", "Quarta - Feira", "Quinta - Feira","Sexta - Feira"], None)
        self.optionmenu_dia.grid(row=1, column=1, sticky="w", padx=10, pady=10)

        self.label_horario = self.widgets.label(self.container, "Escolha o horário do dia: ", cor="transparent")
        self.label_horario.grid(row=2, column=0, sticky="w", padx=10, pady=10)
        
        self.optionmenu_horario = self.widgets.option_menu(self.container, ["08:00h", "09:00h", "10:00h", "11:00h", "13:00h", "14:00h"], None)
